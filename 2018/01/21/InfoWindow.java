...
//                InfoWindow.class.getResource("back.jpg")));
...
//    }
    public InfoWindow() {
        addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent e) {
                do_this_mousedPressed(e);
            }
        });
        setBounds(100, 100, 359, 228);
        BGPanel panel = new BGPanel();
        panel.setImage(Toolkit.getDefaultToolkit().getImage(InfoWindow.class.getResource("back.jpg")));
        getContentPane().add(panel, BorderLayout.CENTER);
    }

    protected void do_this_mousedPressed(MouseEvent e) {
        dispose();
    }
}
