...
public class MainFrame6 extends JFrame implements Printable {
    ...
    private String watermarkWord = "renkaigis"; // 水印文字

    public static void main(String args[]) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    MainFrame6 frame = new MainFrame6();
    ...
    class PreviewCanvas extends Canvas {
        public void paint(Graphics g) {
            try {
                ...
                MainFrame6.this.print(g, pf, 0);// 调用print()方法
