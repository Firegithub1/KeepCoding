...
public class MainFrame3 extends JFrame {
    ...
    public MainFrame3() {
        ...
        backgroundPanel.setImage(SwingResourceManager.getImage(MainFrame3.class,
                "/images/plowland.jpg"));
        ...
        button.setRolloverIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/播种1.png"));
        button.setBorderPainted(false);
        button.setContentAreaFilled(false);
        button.setIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/播种.png"));
        ...
        button_1.setRolloverIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/生长1.png"));
        button_1.setIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/生长.png"));
        ...
        button_2.setRolloverIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/开花1.png"));
        button_2.setIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/开花.png"));
        ...
        button_3.setRolloverIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/结果1.png"));
        button_3.setIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/结果.png"));
        ...
        button_4.setRolloverIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/收获1.png"));
        button_4.setIcon(SwingResourceManager.getIcon(MainFrame3.class,
                "/images/收获.png"));
