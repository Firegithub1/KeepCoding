...
public class CinefilmEffectFrame extends JFrame {
    ...
    public CinefilmEffectFrame() {
        ...
        ggLabel.setIcon(SwingResourceManager1.getIcon(CinefilmEffectFrame.class,
                "/image/胶片.JPG"));
        ggLabel.setText("  ");
        getContentPane().add(ggLabel, BorderLayout.NORTH);

        ffLabel.setText("  ");
        ffLabel.setIcon(SwingResourceManager1.getIcon(CinefilmEffectFrame.class,
                "/image/胶片.JPG"));
        ...
        label_1.setIcon(SwingResourceManager1.getIcon(CinefilmEffectFrame.class,
                "/image/1.jpg"));
        label_1.setText("New JLabelfdbb");
        panel.add(label_1);
        label_2.setBounds(98, 0, 98, 210);
        label_2.setIcon(SwingResourceManager1.getIcon(CinefilmEffectFrame.class,
                "/image/2.jpg"));
        label_2.setText("22222222222222");
        panel.add(label_2);
        label_3.setBounds(196, 0, 98, 210);
        label_3.setIcon(SwingResourceManager1.getIcon(CinefilmEffectFrame.class,
                "/image/3.jpg"));
        label_3.setText("11111111111111");
        panel.add(label_3);
        label_4.setBounds(294, 0, 98, 210);
        label_4.setIcon(SwingResourceManager1.getIcon(CinefilmEffectFrame.class,
                "/image/4.jpg"));
        label_4.setText("New JLabelfdww");
        panel.add(label_4);
        label_5.setBounds(392, 0, 98, 210);
        label_5.setIcon(SwingResourceManager1.getIcon(CinefilmEffectFrame.class,
                "/image/5.jpg"));
            ...
            while (true) {
                ...
                if (x1 == -98) { // 当第1个标签的显示位置是-98时执行
                    ...
                    if (indexFlag) {
                        ...
                        label_1.setIcon(SwingResourceManager1.getIcon(
                ...
                if (x2 == -98) { // 当第2个标签的显示位置是-98时执行
                    ...
                    if (indexFlag) {
                        // indexFlag为true时改变的图片
                        label_2.setIcon(SwingResourceManager1.getIcon(
                ...
                if (x3 == -98) { // 当第3个标签的显示位置是-98时执行
                    ...
                    if (indexFlag) {
                        // indexFlag为true时改变的图片
                        label_3.setIcon(SwingResourceManager1.getIcon(
                ...
                if (x4 == -98) { // 当第4个标签的显示位置是-98时执行
                    ...
                    if (indexFlag) {
                        // indexFlag为true时改变的图片
                        label_4.setIcon(SwingResourceManager1.getIcon(
                ...
                if (x5 == -98) { // 当第5个标签的显示位置是-98时执行
                    ...
                    if (indexFlag) {
                        // indexFlag为true时改变的图片
                        label_5.setIcon(SwingResourceManager1.getIcon(
