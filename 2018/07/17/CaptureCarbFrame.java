...
public class CaptureCarbFrame extends JFrame implements Runnable {
    ...
    public CaptureCarbFrame() {
        super();
        // 创建第一个鼠标图标
        ImageIcon icon = new ImageIcon(getClass().getResource("image/hand.jpg"));
        // 创建第二个鼠标图标
        ImageIcon icon2 = new ImageIcon(getClass().getResource("image/hand2.jpg"));
        // 获取每个图标的图片
        ...
        // 初始化背景图片对象
        ImageIcon img = new ImageIcon(getClass().getResource("image/background.jpg"));
        // 初始化螃蟹图片对象
        imgCarb = new ImageIcon(getClass().getResource("image/crab.png"));
        imgCarb2 = new ImageIcon(getClass().getResource("image/crab2.png"));
