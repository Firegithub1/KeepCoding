...
public class MainFrame2 extends JFrame {
    ...
    private BackgroundPanel1 backgroundPanel;
    ...
    public MainFrame2() {
        ...
        backgroundPanel = new BackgroundPanel1();// 创建带背景的面板
        backgroundPanel.setImage(new ImageIcon(getClass()
                .getResource("image/background.jpg")).getImage());// 设置背景图片
    ...
    private final class FrameMouseListener extends MouseAdapter {
        public void mousePressed(final MouseEvent e) {
            Component at = backgroundPanel.getComponentAt(e
                    .getPoint());
            if (at instanceof BackgroundPanel1) {// 如果点到面板也扣除子弹
                MainFrame2.useAmmo();// 消耗子弹
            }
        }
    }
