...
public class PictureFadeFrame1 extends JFrame {
    ...
    public static void main(String args[]) {
        PictureFadeFrame1 frame = new PictureFadeFrame1();
        frame.setVisible(true);
    }

    public PictureFadeFrame1() {
        super();
        imgUrl = PictureFadeFrame1.class.getResource("/img/image.jpg");// 获取图片资源的路径
        img = Toolkit.getDefaultToolkit().getImage(imgUrl); // 获取图像对象
        imgUrl = PictureFadeFrame1.class.getResource("/img/fade.jpg");// 获取图片资源的路径
