...
public class EditableTree2 extends JFrame {
    ...
    protected void do_button_actionPerformed(ActionEvent e) {
        ...
        if ((selectNode == null) || (selectNode.isRoot())) { // 如果没有选择节点或选择了根节点则返回
            return;
        }
        DefaultTreeModel model = (DefaultTreeModel) tree.getModel(); // 获得当前树的模型
        model.removeNodeFromParent(selectNode); // 删除节点
        tree.repaint(); // 重新绘制树
    }
}
