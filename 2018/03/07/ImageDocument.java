...
public class ImageDocument extends JFrame {
    ...
    protected void do_this_windowActivated(WindowEvent e) {
        ...
        Style imageStyle = new StyleContext().addStyle("Image", null); // 新建样式
        StyleConstants.setIcon(imageStyle, new ImageIcon("07/logo.jpg"));
        DefaultStyledDocument document = new DefaultStyledDocument();
        try {
            document.insertString(0, "image", imageStyle); // 插入图片
            document.insertString(document.getLength(), heading + content, null); // 插入文本
