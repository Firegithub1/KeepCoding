...
public class ToolTipNodeTest extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ToolTipNodeTest frame = new ToolTipNodeTest();
    ...
    protected void do_this_windowActivated(WindowEvent e) {
        ...
        Map<DefaultMutableTreeNode, String> map = new HashMap<DefaultMutableTreeNode, String>(); // 利用映射保存提示信息
        map.put(root, "明日科技"); // 增加提示信息
        map.put(parent1, "明日科技");
        map.put(parent2, "明日科技");
        tree.setCellRenderer(new ToolTipNode(map)); // 设置新的渲染器
    }
}
