...
public class ImageTabbedCard extends JFrame {
    ...
    protected void do_this_windowActivated(WindowEvent e) {
        tabbedPane.setIconAt(0, new ImageIcon("17/1.png")); // 第一个选项卡使用图片1
        tabbedPane.setIconAt(1, new ImageIcon("17/2.png"));
        tabbedPane.setIconAt(2, new ImageIcon("17/3.png"));
        tabbedPane.setIconAt(3, new ImageIcon("17/4.png"));
    }
}
