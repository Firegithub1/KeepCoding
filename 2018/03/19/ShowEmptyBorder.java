...
public class ShowEmptyBorder extends JFrame {
    ...
    public ShowEmptyBorder() {
        ...
        button.setBorder(new EmptyBorder(40, 0, 0, 0));// 顶部留白：40pix
        button.setBounds(19, 106, 109, 64);
        contentPane.add(button);

        JButton button_1 = new JButton("演示按钮");
        button_1.setBorder(new EmptyBorder(0, 40, 0, 0));// 左侧留白：40pix
        button_1.setBounds(177, 14, 109, 64);
        contentPane.add(button_1);

        JButton button_2 = new JButton("演示按钮");
        button_2.setBorder(new EmptyBorder(0, 0, 0, 40));// 右侧留白：40pix
        ...
        button_4.setBorder(new EmptyBorder(0, 0, 40, 40));// 右侧和底部留白：40pix
        button_4.setBounds(19, 201, 109, 64);
        contentPane.add(button_4);

        JButton button_5 = new JButton("演示按钮");
        button_5.setBorder(new EmptyBorder(40, 40, 0, 0));// 左侧和顶部留白：40pix
