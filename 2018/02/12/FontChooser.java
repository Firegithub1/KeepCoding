...
public class FontChooser extends JFrame {
    ...
    public FontChooser() {
        ...
        menu1.setFont(new Font("微软雅黑", Font.PLAIN, 16));
        menuBar.add(menu1);

        bold = new JCheckBoxMenuItem("\u52A0\u7C97");
        bold.setFont(new Font("微软雅黑", Font.PLAIN, 16));
        bold.addActionListener(listener);
        menu1.add(bold);

        italic = new JCheckBoxMenuItem("\u659C\u4F53");
        italic.setFont(new Font("微软雅黑", Font.PLAIN, 16));
        italic.addActionListener(listener);
        menu1.add(italic);

        JMenu menu2 = new JMenu("\u5355\u9009\u6309\u94AE\u83DC\u5355\u9879");
        menu2.setFont(new Font("微软雅黑", Font.PLAIN, 16));
        menuBar.add(menu2);
        ...
        radioButtonMenuItem1.setFont(new Font("华文隶书", Font.PLAIN, 16));
        ...
        radioButtonMenuItem2.setFont(new Font("微软雅黑", Font.PLAIN, 16));
        ...
        radioButtonMenuItem3.setFont(new Font("方正舒体", Font.PLAIN, 16));
    ...
    private ActionListener listener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (bold.isSelected()) {
                mode += Font.BOLD; // 如果加粗复选框按钮项被选择，则让 mode 值发生变化
            }
    ...
    protected void do_radioButtonMenuItem1_actionPerformed(ActionEvent e) {
        Font font = label.getFont(); // 获得标签正在使用的字体
        label.setFont(new Font("华文隶书", font.getStyle(), font.getSize()));
    }

    protected void do_radioButtonMenuItem2_actionPerformed(ActionEvent e) {
        Font font = label.getFont();
        label.setFont(new Font("微软雅黑", font.getStyle(), font.getSize()));
    }

    protected void do_radioButtonMenuItem3_actionPerformed(ActionEvent e) {
        Font font = label.getFont();
        label.setFont(new Font("方正舒体", font.getStyle(), font.getSize()));
    }
}
