...
public class JRadioButtonTest extends JFrame {
    ...
    protected void do_radioButton1_actionPerformed(ActionEvent e) {
        if (radioButton1.isSelected()) { // 如果单选按钮被选中
            ImageIcon icon = new ImageIcon("09/1.png"); // 创建图片图标
    ...
    protected void do_radioButton2_actionPerformed(ActionEvent e) {
        if (radioButton2.isSelected()) {
            ImageIcon icon = new ImageIcon("09/2.png");
            label.setIcon(icon);
        }
    }
    ...
    protected void do_radioButton3_actionPerformed(ActionEvent e) {
        if (radioButton3.isSelected()) {
            ImageIcon icon = new ImageIcon("09/3.png");
            label.setIcon(icon);
        }
    }
}
