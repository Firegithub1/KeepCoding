...
public class VoteSystem extends JFrame {
    ...
    public VoteSystem() {
        ...
        checkBox1.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        progressBar1.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        checkBox2.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        progressBar2.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        checkBox3.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        progressBar3.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        checkBox4.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        progressBar4.setFont(new Font("微软雅黑", Font.PLAIN, 14));
    ...
    protected void do_submitButton_actionPerformed(ActionEvent e) {
        ...
        double total = number1 + number2 + number3 + number4; // 计算总共的票数
        progressBar1.setString(number1 * 100 / total + "%"); // 在进度条上显示所占比例的文本信息
        progressBar1.setValue(number1); // 在进度条上显示票数
