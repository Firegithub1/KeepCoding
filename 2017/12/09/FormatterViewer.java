...
public class FormatterViewer extends JFrame {
    ...
    public FormatterViewer() {
        ...
        formatterComboBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                do_formatterComboBox_actionPerformed(e);
            }
        });
    ...
    protected void do_this_windowActivated(WindowEvent e) {
        String[] pattenExamples = {"yyyy-MM-dd", "MM-dd-yyyy", "a h:m:s", "z H:m:s"};
        for (String patten : pattenExamples) { // 遍历整个数组
            formatterComboBox.addItem(patten); // 给组合框增加元素
        }
    }

    protected void do_formatterComboBox_actionPerformed(ActionEvent e) {
