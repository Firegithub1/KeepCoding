...
public class ElectronicClock extends JFrame {
    ...
    private ImageIcon colon = new ImageIcon("06/images/colon.png");
    private ImageIcon[] numbers = {new ImageIcon("06/images/0.png"), new ImageIcon("06/images/1.png"), new ImageIcon("06/images/2.png"), new ImageIcon("06/images/3.png"),
            new ImageIcon("06/images/4.png"), new ImageIcon("06/images/5.png"), new ImageIcon("06/images/6.png"), new ImageIcon("06/images/7.png"),
            new ImageIcon("06/images/8.png"), new ImageIcon("06/images/9.png")};
