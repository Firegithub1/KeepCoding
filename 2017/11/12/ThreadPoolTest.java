...
public class ThreadPoolTest {
    public static void main(String[] args) {
        ...
        System.out.println("独立运行 1000 个线程所占用的内存：" + (freeMemory - run.freeMemory()) + "字节"); // 查看内存的变化
        System.out.println("独立创建 1000 个线程所消耗的时间：" + (System.currentTimeMillis() - currentTime) + "毫秒"); // 查看时间的变化
        ...
        System.out.println("使用连接池运行 1000 个线程所占用的内存：" + (freeMemory - run.freeMemory()) + "字节"); // 查看内存的变化
        System.out.println("使用连接池创建 1000 个线程所消耗的时间：" + (System.currentTimeMillis() - currentTime) + "毫秒"); // 查看时间的变化
    }
}
