    ...
    public void run() {
        ...
        if (flag == true) {
            synchronized (o1) { // 为o1加锁
                ...
                System.out.println(threadName + "进入同步 o1 准备进入 o2"); // 显示进入o1块
                synchronized (o2) {
                    System.out.println(threadName + "已经进入同步块 o2"); // 显示进入o2块
                }
            }
        }
        if (flag == false) {
            synchronized (o2) {
                ...
                System.out.println(threadName + "进入同步块 o2 准备进入 o1"); // 显示进入o2块
                synchronized (o1) {
                    System.out.println(threadName + "已经进入同步块 o1"); // 显示进入o1块
                }
            }
        }
    }
