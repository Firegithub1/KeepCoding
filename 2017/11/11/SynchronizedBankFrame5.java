...
public class SynchronizedBankFrame5 extends JFrame {
    ...
    protected void do_button_actionPerformed(ActionEvent arg0) {
        ...
        Transfer3 transfer1 = new Transfer3(bank, thread1TextArea);// 创建Transfer对象
        Transfer3 transfer2 = new Transfer3(bank, thread2TextArea);// 创建Transfer对象
