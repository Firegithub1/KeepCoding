...
public class FrameShowException extends JFrame {
    ...
    public FrameShowException() {
        ...
        JLabel label = new JLabel("\u8BF7\u8F93\u5165\u975E\u6570\u5B57\u5B57\u7B26\u4E32\uFF0C\u67E5\u770B\u8F6C\u6362\u4E3A\u6570\u5B57\u65F6\u53D1\u751F\u7684\u5F02\u5E38\u3002");
        label.setBounds(10, 10, 414, 15);
        contentPane.add(label);

        textField = new JTextField();
        textField.setBounds(10, 35, 241, 21);
        contentPane.add(textField);
        textField.setColumns(10);

        JButton button = new JButton("\u8F6C\u6362\u4E3AInteger\u7C7B\u578B");
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                do_button_actionPerformed(e);
            }
        });
        button.setBounds(261, 35, 149, 23);
    ...
    protected void do_button_actionPerformed(ActionEvent e) {
        ...
        if (info.isEmpty()) { // 显示正常转换的提示信息
            ...
            textArea.setText("错啦！转换过程中出现了如下的异常错误：\n" + info);
        }
    }
}
